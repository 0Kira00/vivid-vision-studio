...
export function SearchBoost() {
  ...
  return (
    <section id="ricerche" className="relative overflow-hidden py-20 md:py-28">
      <div className="mx-auto w-[min(96%,1180px)]">
        {/* Section header — same numbered style as the rest of the site */}
        <div className="mb-12 md:mb-16">
          <span className="mx-auto flex w-fit items-center gap-2 rounded-full border border-border bg-surface px-3 py-1 text-[10px] uppercase tracking-[0.16em] text-ink-soft">
